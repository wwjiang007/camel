...
A new `statement` endpoint option has been added to support SQL++ (N1QL) queries as the recommended
alternative. See the component documentation for migration guidance.
