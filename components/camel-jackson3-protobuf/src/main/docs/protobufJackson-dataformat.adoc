...
https://github.com/FasterXML/jackson/[Jackson library] version 3 with the https://github.com/FasterXML/jackson-dataformats-binary[Protobuf extension]
...
on *camel-jackson3-protobuf*, which implements this data format.
