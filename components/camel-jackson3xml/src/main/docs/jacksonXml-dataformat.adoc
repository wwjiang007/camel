...
:camel-spring-boot-name: jackson3xml
...
use https://github.com/FasterXML/jackson-annotations/blob/master/src/main/java/tools/jackson/annotation/JsonView.java[JSON views] to accomplish
...
Directly specify your https://github.com/FasterXML/jackson-annotations/blob/master/src/main/java/tools/jackson/annotation/JsonView.java[JSON
...
the `org.apache.camel.component.jackson3xml.ListJacksonXMLDataFormat`.
